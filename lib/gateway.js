// dsh-web-auth-gateway — the gateway HTTP server: login page + session
 ...
 * unavailable in this browser") and plugin configuration cards even though
 * the gateway has authenticated the request. The patched client
 * (dsh-client-connection/client.js) treats this marker as loopback trust.
 */
